package com.tinytrust.epos.common.statics;
...
public class Constant {
     ...
     * 订单状态 待确认
     * <p/>
     * 微店点单 (系统自动下载已经付款等待发货的订单,状态为-1,轮询查询确认收货后状态修改为1,后续流程按照订单重置流程走)
     */
    public static final int ORDER_STATE_PRECHECK = -1;
     ...
     * 微店(手动)订单费率开关- 打开
     */
    public static final int WEIDIAN_ORDER_FEERATE_OPEN = 1;

    /**
     * 微店(手动)订单费率开关- 关闭
     */
    public static final int WEIDIAN_ORDER_FEERATE_CLOSE = 2;
